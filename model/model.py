...
for img_size in [112,224,512]:
    for batch_size in [4, 8, 16]:
        for initial_learning_rate in [1e-8, 1e-7, 1e-6]:
            ...
            vgg_pretrained_model = VGG16(weights="imagenet", 
                                         include_top= False,
                                         input_tensor=keras.Input(image_size + (3,))) # shape=(size, size,3)
